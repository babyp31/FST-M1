...
public class activity6 {
    ...
    public void loginwithinvalid(){
        ...
        driver.findElement(AppiumBy.xpath("//android.webkit.WebView[@text='Popups']/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.widget.EditText[1]")).sendKeys("poulami");
        driver.findElement(AppiumBy.xpath("//android.webkit.WebView[@text='Popups']/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.widget.EditText[2]")).sendKeys("password2");
        driver.findElement(AppiumBy.xpath("//android.widget.Button[@text='Log in']")).click();
