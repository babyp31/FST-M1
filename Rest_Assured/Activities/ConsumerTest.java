...
public class ConsumerTest {
    ...
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        ...
        DslPart reqAndResponseBody = new PactDslJsonBody()
                .numberType("id", 123)
                .stringType("firstName", "baby")
                .stringType("lastName","sahoo")
                .stringType("email", "baby@gmail.com");
    ...
    public void postRequestTest(){
        ...
        reqBody.put("id", 123);
        reqBody.put("firstName", "baby");
        reqBody.put("lastName","sahoo");
        reqBody.put("email", "baby@gmail.com");
